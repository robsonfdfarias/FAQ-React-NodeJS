        ...
        <div id="footerPages">
            <div id="footerCenter">
                <div id="camada1Footer">
                    <span id="login">{localStorage.getItem("nome")?<span>Usuário: {localStorage.getItem("nome")} - <a href="\sair"> Sair</a></span>:<a href="/login" target="_blank" rel="noopener noreferrer">Logar</a>}</span>
                    <span id="redesFooter">
                        <a href="#">
